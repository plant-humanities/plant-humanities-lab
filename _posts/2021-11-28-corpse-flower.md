...
{% include embed/youtube.html vid="5upF4rJUxC4" caption="NYBG 2019 Corpse Flower Timelapse" aspect="1.55" %}
...
{% include embed/image.html id="corpse-1" src="wc:Corpse_Flower_%28Amorphophallus_Titanum%29_1_of_5.jpg" caption="Corpse Flower (Amorphophallus Titanum) in full bloom at Edmonton's Muttart Conservatory, April 7, 2015." aspect="1.05" %}
...
{% include embed/image.html src="cm16465_titan_arum_life_cycle_17x11.jpg" caption="Corpse Flower Lifecycle, USGB" source="https://www.usbg.gov/sites/default/files/images/cm16465_titan_arum_life_cycle_17x11.jpg" aspect="1.55" %}
{% include embed/youtube.html vid="lQwFAZKLxEE" aspect="1.55" %}
...
{% include embed/youtube.html vid="L-Tp9cDj7Vg" caption="USBG Corpse Flower 2020: Live Horticulture Q&A" aspect="1.55" %}
...
{% include embed/map.html center="Q3492" zoom="4" geojson="corpse_flower.json" %}
{% include embed/image.html src="wc:COLLECTIE_TROPENMUSEUM_Indonesische_mannen_poseren_bij_twee_verschillende_soorten_Amorphophallus_planten_waaronder_een_in_bloei_staande_Amorphophallus_Titanum_TMnr_60042790.jpg" caption="Indonesian men pose with two Amorphophallus plants (one in bloom), c. 1900-1940" aspect="0.83" %}
...
{% include embed/map.html center="Q18748726" zoom="11" geojson="/corpse_flower.json" %}
{% include embed/image.html src="Kew_historic_Corpse_Flower.jpg" caption="Corpse Flower Bloom, Kew, 1901" aspect="1.7" %}
...
{% include embed/map.html center="Q636275" zoom="14" geojson="corpse_flower.json" %}
...
{% include embed/image.html src="iunc_CF.jpg" caption="IUNC Red List Map Extant (resident) _Amorphophallus titanum_ species 2018" aspect="1.82" %}
...
{% include embed/image.html src="mco-6927-1_1-768x768.jpg" caption="Mark Hachadourian with a Corpse Flower at the NYBG" source="https://www.nybg.org/content/uploads/2018/06/mco-6927-1_1-768x768.jpg" aspect="1" %}
