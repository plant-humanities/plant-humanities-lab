...
{% include embed/image.html src="Treebark_HongKong.jpg" caption="_Australian paperbark trees line a main road, New Territories, Hong Kong_, Hedda Morrison, 1946-1947" description="_Melaleuca quinquinervia_ Lining a Road, Hong Kong [Date]" aspect="1.26" %}
...
{% include embed/map.html center="18.64173,15.46875" zoom="1" basemap="Esri_WorldPhysical" caption="Map of the global spread of M. quinquenervia. Bethany Kidd and Sierra Roark, ArcGIS, 2025." markers="" geojson="GlobalReach.json" %}
...
{% include embed/image.html src="PaperbarkTree_Lightning_LangePark.jpg" caption="_Melaleuca_ tree growing in Lange Park, struck by lightning in 1990" aspect="1.33" %}
{% include embed/image.html src="LangePark_plaque.jpg" caption="Memorial plaque at Lange Park" aspect="1.33" %}
...
{% include embed/image.html src="wc:Melaleuca_quinquenervia_inflorescenes_7th_Brigade_Park_Chermside_L1020182.jpg" caption="Paperbark in flower" aspect="1.33" %}
{% include embed/image.html src="wc:Melaleuca_quinquenervia_Wyrrabalong_NP_1.jpg" caption="Bark structure" aspect="0.75" %}
{% include embed/image.html src="wc:Starr-070302-4964-Melaleuca_quinquenervia-leaves_and_bifurcate_fruit-Pukalani-Maui_(24256633283).jpg" caption="Paperbark fruit" aspect="0.75" %}
...
{% include embed/image.html src="wc:G.E._Rumphius,_D'Amboinsche,_frontispiece._Wellcome_L0022386.jpg" caption="Portrait of Georg Eberhard Rumpf, alias Rumphius, (1627-1702)" aspect="0.65" %}
...
{% include embed/iframe.html src="https://books.google.com/books?id=3gpiDsqePMcC&newbks=0&dq=Herbarium%20amboinense%20%3A%20plurimas%20conplectens%20arbores%2C%20frutices%2C%20herbas%2C%20plantas%20terrestres&pg=PA68-IA1&output=embed" caption="Georg Eberhard Rumpf, *Herbarium Amboinense*, 1741" aspect="0.6" %}
...
{% include embed/image.html src="wc:Melaleuca_quinquenervia_Wyrrabalong_NP_2.jpg" caption="Paperbark after a bushfire" aspect="0.75" %}
...
{% include embed/image.html src="PaperbarkHerbarium.jpeg" caption="Banks and Solander herbarium specimen. Queensland Herbarium, 2019." aspect="0.74" %}
{% include embed/image.html src="Banks_Florilegium.jpg" caption="Banks' Florilegium" aspect="0.75" %}
{% include embed/image.html src="cavdes.jpg" caption="Description of *Metrosideros quinquenervia* in Cavanilles, _Icones et descriptions plantarum_, 1797" aspect="0.63" %}
{% include embed/image.html src="cavimage.jpg" caption="*Metrosideros quinquenervia, in Cavanilles, _Icones et descriptions plantarum_, 1797" aspect="0.61" %}
...
{% include embed/youtube.html vid="1n-zJNdfQJI" caption="Paperbark, Aboriginal Spirit by Shaman Creative" aspect="1.55" %}
...
{% include embed/vis-network.html id="paperbark" caption="Created by Bethany Kidd and Sierra Roark, 2025" aspect="1" %}
...
{% include embed/image.html src="oil.jpg" caption="Tea tree oil" description="Use of tea tree oil on the skin" license="Unsplash photos are made to be used freely" aspect="1.5" %}
...
{% include embed/image.html src="Paperbarkhut.png" caption="Two people sitting in front of a bush hut, Queensland, ca. 1895. Image courtesy of the State Library of Queensland" aspect="1.05" %}
{% include embed/image.html src="dwellings.jpg" caption="Aboriginal men and a child outside of two paperbark humpies, Victoria River, NT, ca. 1900" aspect="1.32" %}
{% include embed/image.html src="wc:Francis_Birtles_in_a_bush_shower_constructed_of_timber_and_paper_bark_strips,_1914_-_Frank_Hurley_(22098482178).jpg" caption="Bush shower of paperbark strips and timber, 1914" aspect="1.6" %}
{% include embed/image.html src="raft.jpg" caption="Two People and a Dog on a Paperbark Canoe, ca. 1940" description="canoe photo" aspect="1.68" %}
{% include embed/image.html src="Raftdesign.png" caption="_Walba_, David Payne" description="raft design" aspect="1.39" %}
...
{% include embed/image.html src="wc:Paperbark_(bark).JPG" caption="Paperbark for food wrapping" aspect="1.48" %}
{% include embed/image.html src="basket.png" caption="Paperbark Basket, England Banggala, 1994" description="basket" aspect="0.81" %}
{% include embed/image.html src="barkpainting.png" caption="_Yikawana ga Nurruguyamirr_, Djambawa Marawili, 1998" description="bark painting" aspect="0.66" %}
...
{% include embed/image.html src="wc:Australian_Museum_-_Joy_of_Museums_-_Coolamons_-_Aboriginal_Carrying_Vessels.jpg" caption="Aboriginal *coolamons* or carrying vessels" aspect="1.1" %}
...
{% include embed/image.html src="Artifact1988.jpg" caption="Two Pieces of Tree Paperbark Bearing Protest Messages, 1988. Image courtesy of the National Archives of Australia, NAA: B5361, P40-0020" description="protest bark" aspect="0.58" %}
...
{% include embed/youtube.html vid="ZPQr30eEQdY" caption="Oodgeroo Noonuccal Reading Her Poems" aspect="1.55" %}
 -->
...
{% include embed/image.html src="wc:Satellite_image_of_bushfire_smoke_over_Eastern_Australia_(December_2019).jpg" caption="Satellite image of bushfire smoke over Easter Australia, 2019" aspect="1.2" %}
...
{% include embed/image.html src="wc:Fire_biologist_lights_controlled_burn_(6022164769).jpg" caption="Controlled burn" aspect="1.33" %}
...
{% include embed/map.html center="27.08847,-81.03516" zoom="7" markers="|" geojson="EvergladesNew.json" caption="Dispersal of paperbark trees in south Florida. Bethany Kidd and Sierra Roark, ArcGIS, 2025." %}
...
{% include embed/image.html src="wc:Starr_031108-0008_Melaleuca_quinquenervia.jpg" caption="_M. quinquenervia_ stand lining I-75 in the Everglades" aspect="1.33" %}
...
{% include embed/image.html src="wc:Melaleuca_leaf_weevil.jpg" caption="_Melaleuca_ leaf weevil" aspect="1.42" %}
...
{% include embed/image.html src="wc:Annona_glabra_01.jpg" caption="*Annona glabra* or pond apple" aspect="1" %}
...
{% include embed/image.html src="16604010.jpg" caption="Opening remarks of the 1994 congressional hearing, _Harmful Non-Indigenous Species in the United States_" source="https://www.biodiversitylibrary.org/pageImage/16604010" aspect="0.58" %}
...
{% include embed/iframe.html src="https://cdn.knightlab.com/libs/timeline3/latest/embed/index.html?source=1eIQ8ZtzRcfK8AHuPcBqMNI-AQAuLnkoVsjklVtHTR6Y&font=Default&lang=en&timenav_position=bottom&hash_bookmark=false&initial_zoom=1" class="full" %}
