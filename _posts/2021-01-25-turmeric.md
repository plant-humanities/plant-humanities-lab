...
{% include embed/image.html src="48537187.jpg" aspect="0.67" caption="Turmeric as Represented in William Woodville's herbal" attribution="_Medical botany_" %}
...
{% include embed/image.html src="55999435.jpg" aspect="0.57" caption="Turmeric in Robert John Thornton's Herbal" attribution="_A Family Herbal_" %}
...
{% include embed/image.html id="img1" src="whitakerspeerage00unse_16_0816.jpg" aspect="0.63" caption="Whitaker's peerage, baronetage, knightage, and companionage p. 801" attribution="_Whitaker's Peerage, Baronetage, Knightage, and Companionage_" %}
