...
{% include embed/image.html src="48537187.jpg" aspect="0.67" caption="Turmeric as Represented in William Woodville's herbal" attribution="*Medical botany*" %}
...
{% include embed/map.html center="15.103853,18.634794" zoom="2" basemap="Esri_WorldPhysical" caption="Former Countries of the British Empire. Julia Fine, ArcGIS, 2021." geojson="british_empire_2.geojson~Former Countries of the British Empire" %}
...
{% include embed/map.html center="3.150845,101.695570" zoom="3.5" basemap="Esri_WorldPhysical" caption="The Origins of Turmeric. Julia Fine, ArcGIS, 2021." geojson="Origins_Turmeric_2.json~Potential Origins of Turmeric" %}
...
{% include embed/map.html center="22.056278,78.936964" zoom="4.1" basemap="Esri_WorldPhysical" caption="Indian Subcontinent. Julia Fine, ArcGIS, 2021." geojson="India_Sub.geojson~Indian Subcontinent" %}
...
{% include embed/map.html center="-0.091300,107.056186" zoom="3.5" basemap="Esri_WorldPhysical" caption="Spread of Turmeric. Julia Fine, ArcGIS, 2021." geojson="Turmeric_Spread.json~Turmeric spreads out" %}
...
{% include embed/map.html center="28.634609,77.204167" zoom="6.5" caption="Delhi. Julia Fine, ArcGIS, 2021." geojson="delhi.json~Delhi" %}
...
{% include embed/map.html center="43.320749,11.330224" zoom="6.5" caption="Mattioli's Birthplace. Julia Fine, ArcGIS, 2021." geojson="siena.json~Mattioli's Birthplace" %}
...
{% include embed/map.html center="51.513184,-0.082066" zoom="5.5" caption="London. Julia Fine, ArcGIS, 2021." geojson="london.json~Pechey's Birthplace" %}
...
{% include embed/map.html center="51.513184,-0.082066" zoom="8" caption="East India House in London. Julia Fine, ArcGIS, 2021." geojson="East_India_House.json~East India House" %}
...
{% include embed/image.html src="55999435.jpg" aspect="0.57" caption="Turmeric in Robert John Thornton's Herbal" attribution="*A Family Herbal*" %}
...
{% include embed/image.html src="kXsCAAAAYAAJ_PR3.png" aspect="0.64" caption="Eliza Acton, *Modern Cookery*, 1845" %}
{% include embed/image.html src="kXsCAAAAYAAJ_PR11.png" aspect="0.67" caption="Eliza Acton, *Modern Cookery*, 1845" %}
...
{% include embed/image.html id="img1" src="whitakerspeerage00unse_16_0816.jpg" aspect="0.63" caption="Whitaker's peerage, baronetage, knightage, and companionage p. 801" attribution="*Whitaker's Peerage, Baronetage, Knightage, and Companionage*" %}
