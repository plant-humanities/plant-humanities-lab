...
{% include embed/image.html src="Aloe_Americana_Leiden_DO.jpg" aspect="0.75" caption="Aloë Americana: heeft gebloeid in des universiteits Kruyd-Hof tot Leiden, 1698, Rare Book Collection, Dumbarton Oaks" %}
...
{% include embed/image.html src="https://tile.loc.gov/image-services/iiif/service:gdc:gdcwdl:wd:l_:10:62:2:wdl_10622:MedPalat220_03_0656/full/pct:25/0/default.jpg" caption="Treating a head wound. Bernardino De Sahagún, Book XI, Historia general de las cosas de Nueva España (Florentine Codex), 1577. Biblioteca Medicea Laurenziana via World Digital Library, public domain." region="pct:31.21,73.38,30.78,15.192" aspect="0.76" %}
...
{% include embed/image.html src="tumblr_nzbju0LvFn1ssxmhoo1_1280.jpg" aspect="0.67" caption="Diego Rivera, Tlachiqueros" %}
...
{% include embed/image.html src="6781301.jpg" aspect="0.65" caption="Due libri dell'historia de i semplici, aromati, et altre cose: che vengono portate dall'Indie Orientali pertinente alla medicina, 1576" attribution="_Due libri dell'historia de i semplici, aromati, et altre cose: che vengono portate dall'Indie Orientali pertinente alla medicina_" %}
...
{% include embed/image.html src="Clusius_Network.jpg" caption="Created by the author, 2021." aspect="1.47" %}
