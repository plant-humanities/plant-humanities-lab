...
{% include embed/map.html center="Q659400" zoom="6" caption="The Venus flytrap’s native range is limited to a roughly 50-mile radius around Wilmington, NC." geojson="flytraprange-2.json~The Venus flytrap’s native range is limited to a roughly 50-mile radius around Wilmington, NC." %}
...
{% include embed/image.html src="Venus_Fly_Trap_Ellis_Oak_Spring_Garden_Foundation_Upperville_Virginia_copyright.jpg" region="0,421,3192,2590" aspect="1.23" caption="Test" %}
...
{% include embed/vis-network.html id="flytrap-correspondence" dataid="flytrap-correspondence-csv" caption="The complex network of knowledge exchange surrounding the Venus flytrap spanned much of Europe and frequently crossed the Atlantic." aspect="1" %}
...
{% include embed/image.html src="alvin-record_232622-ATTACHMENT-0003.jpeg" aspect="0.83" %}
...
{% include embed/image.html id="img4" src="L0025495.jpg" aspect="1.3" %}
...
{% include embed/image.html src="sealandillustrat00buel_0486.jpg" aspect="0.64" %}
...
{% include embed/map.html center="Q1558" zoom="3" caption="Introduced populations of the Venus flytrap have been established across the United States and Caribbean, and are today grown commercially worldwide." geojson="introducedrange.json" %}
