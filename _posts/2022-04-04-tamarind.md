...
{% include embed/vis-network.html id="tamarindus_countries" caption="Tamarindus Countries. Created by Allison Fulton, Amara Santiesteban Serrano, and Jeannette Schollaert, 2022." %}
...
{% include embed/map.html center="-0.70311,10.54688" zoom="1" basemap="Esri_WorldGrayCanvas" caption="The spread of tamarind. Allison Fulton, Amara Santiesteban Serrano, and Jeannette Schollaert, ArcGIS, 2022." geojson="Tamarind_map.json" %}
...
{% include embed/image.html id="img1" src="Mughal_style_tamarind_Brit_Lib_copyright_The_British_Library.jpg" aspect="0.61" caption="Tamarind Tree, Bãburnãma (Vaki’at-i Baburi), 1590, Or. 3714 Vol. 4 f.397." %}
...
{% include embed/image.html src="Babur_supervising_laying_out_Victoria_Albert_Mus_copyright_Victoria_Albert_Museum.jpg" aspect="0.77" caption="Bishndas, Babur supervising the laying out of a Kabul garden, Bãburnãma, c. 1590, opaque watercolor on paper, 21.7 × 14.3 cm." attribution="Bãburnãma" %}
...
{% include embed/image.html id="img2" src="b12023747_V0017117.jpg" aspect="0.87" caption="Nicolas de Larmessin II's painting Personifications of medicine, pharmacy and surgery, 1695. Wellcome Collection." %}
...
{% include embed/image.html src="b28125800_0001_0057.jpg" aspect="0.6" caption="Old Tamarind Trees in J.D. Hooker's *Himalayan Journals*, 1891." %}
...
{% include embed/image.html src="container_strawbery_banke_copyright_Strawbery_Banke_Museum_2017.jpeg" aspect="0.75" caption="Shipping Container, redware, H. 15 inches, artifact SB1.0426." %}
...
{% include embed/image.html src="LSW_RBGM_MN_CD3_279-001.jpg" aspect="1.46" caption="Marianne North, African Baobab Trees, a Large Tamarind, the God Aiyanar and His Two Wives, c.1878, oil on board, 24.6 x 35.5 cm." %}
...
{% include embed/image.html src="b21528640_0174.jpg" aspect="0.63" caption="Flora Steel and Grace Gardiner, *The Complete Indian Housekeeper and Cook*, 1909" %}
...
{% include embed/image.html src="b11916606_V0019937-LS-LS.jpg" aspect="0.71" caption="J. Bouvier, 
A female Anglo-Indian at her toilet being attended by three Indian servants, 1842. Wellcome Collection." %}
...
{% include embed/image.html src="2015.336370.Amish-O_0006.jpg" aspect="0.65" caption=Pragyasundari Devi, *Aamis O Niramish Aahar*, 1902" %}
...
{% include embed/image.html src="sweet_tamarind_seeds_Flicker_CC_BY_NC_ND_2.0.png" caption="Sweet tamarind, 2007. Flickr." aspect="1.33" %}
