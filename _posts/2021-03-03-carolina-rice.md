...
{% include embed/image.html src="wc:The-rice-bird.jpg" caption="Illustration of Rice and the Rice-Bird in the Carolina Colony, 1754." aspect="1.41" %}
...
{% include embed/map.html center="30.14755,2.10938" zoom="1" caption="Different Areas of Carolina Rice Cultivation" geojson="carolina_rice_points.json~Different areas of Carolina Rice Cultivation" %}
...
{% include embed/map.html center="32.779411,-79.943708" zoom="7" caption="The Carolina Lowcountry" geojson="lowcountry.json" %}
...
{% include embed/map.html center="12.586420,-8.107447" zoom="3" caption="The Origins of Carolina Rice" geojson="west_africa.json~The Origins of Oryza glaberrima" %}
...
{% include embed/map.html center="12.89229,-39.02344" zoom="2" caption="The Middle Passage" geojson="middle_passage.json" %}
...
{% include embed/map.html center="4.21158,-2.10938" zoom="1" caption="The Transfer of Carolina Rice to India" geojson="carolina_rice_transfer.json" %}
...
{% include embed/map.html center="17.94766,85.19487" zoom="4.2" caption="Where Carolina Rice was Grown Throughout British India" geojson="indiaetc.json~Rice Transfers across Southern Asia" %}
...
{% include embed/map.html center="19.083495,72.866069" zoom="8" caption="Bombay" geojson="bombay.json~Bombay" %}
...
{% include embed/map.html center="17.51021,84.50625" zoom="4.2" caption="Where Carolina Rice was Grown Throughout British India" geojson="indiaetc.json~Rice Transfers across Southern Asia" %}
...
{% include embed/map.html center="23.88584,0.70313" zoom="1" caption="The Varied Geographies of Carolina Rice" geojson="carolina_rice_points.json~The Varied Geographies of Carolina Rice" %}
