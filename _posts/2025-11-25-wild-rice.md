...
{% include embed/image.html src="KEW_POW_Z_palustris.jpg" caption="Zizania palustris type specimen. Royal Botanic Gardens Kew." aspect=".697" %}
{% include embed/image.html src="Kew_POW_Z_palustris_dist.png" caption="Global distribution of Zizania palustris. Flora Klein, ArcGIS, 2025." aspect="2.661" %}
...
{% include embed/image.html src="MNdams.jpg" caption="Dams in Minnesota. Flora Klein, ArcGIS, 2025." aspect=".75" %}
...
{% include embed/image.html src="wc:Aylmer_Bourke_Lambert._Stipple_engraving_by_W._Holl,_1805,_a_Wellcome_V0003335.jpg" caption="Stipple engraving of Aylmer Bourke Lambert" aspect="0.73" %}
{% include embed/image.html src="wc:François_André_Michaux_(1770–1855).jpg" caption="Portrait of François André Michaux" aspect="0.74" %}
...
{% include embed/image.html src="NL000379_o2.jpg" caption="Seth Eastman's painting 'Gathering Wild Rice,' Internet Archive" %}
...
{% include embed/image-compare.html before="wc:Wild_rice_plants_-_NARA_-_285206.jpg" after="wc:Northern_Wild_Rice_(Zizania_palustris),_Coventry,_RI_(39518308664).jpg" class="right" caption="Swipe across images to view the conditions of wild rice habitat in 2010 and 1937. Left: Northern Wild Rice (Zizania palustris) in 2010, Wikimedia Commons. Right: Wild Rice plants in 1937, Wikimedia Commons."%}
{% include embed/iframe.html src="https://tile.loc.gov/storage-services/public/gdcmassbookdig/wildricegatherer00jenk/wildricegatherer00jenk.pdf" caption="Albert Jenks, *Wild Rice Gatherers of the Upper Lakes*, 1907" %}
...
{% include embed/image.html src="wild_rice_lakes_dnr.jpg" caption="Wild rice lakes in Minnesota. Flora Klein, ArcGIS, 2025." aspect=".75" %}
...
{% include embed/image.html src="st_louis_watershed.jpg" caption="St. Louis Watershed lakes, wetlands, and peat deposits. Flora Klein, ArcGIS, 2025." aspect="1.5" %}
