...
{% include embed/image.html src="bm000589107.jpg" aspect="0.66" caption="Botanical illustration of Theobroma cacao by Everard Kickius (likely 1700-1701) of specimen from  Sir Hans Sloane's collection." %}
...
{% include embed/image.html src="us00102185.jpg" aspect="0.79" caption="Herbarium specimen of Theobroma cacao collected by F. Miranda in Chiapas, Mexico (1962)." %}
...
{% include embed/image.html src="MilpaCycle.png" label="Milpa Cycle" aspect="1.02" caption="Milpa Cycle" %}
...
{% include embed/image.html src="9089.jpg" caption="Maya God L seated in merchant regalia with cacao symbolism on left; God K on the right." aspect="3.31" %}
{% include embed/image.html src="0631.jpg" region="367,125,784,587" caption="Maya God L seated in merchant regalia; God K to the right next to a cacao tree." aspect="1.64" %}
{% include embed/image.html src="GodLVessel.jpg" aspect="1.08" caption="Maya God L with cacao symbolism seated in merchant regalia" %}
...
{% include embed/image.html src="56601539.jpg" region="503,861,1701,1273" aspect="0.73" caption="Theatrum Botanicum p. 1642" %}
{% include embed/image.html src="8066123.jpg" caption="Theatrum Botanicum p. 1642" attribution="Research Library, The Getty Research Institute via archive.org and BHL" aspect="0.60" %}
