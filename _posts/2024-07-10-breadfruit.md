...
{% include embed/image.html src="breadfruitMongabay.jpg" caption="A breadfruit tree in Southeast Asia" attribution="Pixabay" license="public domain" aspect="1.50" %}
...
{% include embed/image.html src="1404034.jpg" caption="Map of Pacific Islands, 1816." attribution="New York Public Library" license="public domain" source="https://iiif-prod.nypl.org/index.php?id=1404034&t=g" aspect="1.26" %}
...
{% include embed/youtube.html vid="Vb8_f1K6FZA" aspect="1.55" %}
...
{% include embed/image.html src="worldSuitabilityMap.png" caption="A map depicting suitable environments for breadfruit cultivation around the world." attribution="Mausio et al. 2020" license="https://creativecommons.org/licenses/by/4.0/" aspect="1.33" %}
...
{% include embed/map.html center="-17.656781,-149.426688" zoom="10" caption="Map of Tahiti" %}
...
{% include embed/image.html src="Parkinson1.jpg" caption="These excellent drawings were done by Sydney Parkinson (1745-1771), the young  botanical illustrator who died of dysentery contracted on Prince’s Island, en route to Cape Town,  and was buried at sea." attribution="Natural History Museum, London" license="public domain" aspect="0.90" %}
{% include embed/image.html src="Parkinson6.jpg" caption="Parkinson illustrations from Cook Voyage, 1768-1771" attribution="Natural History Museum, London" license="public domain" aspect="0.90" %}
...
{% include embed/image.html src="ParkinsonWater.jpg" caption="Parkinson Watercolor of breadfruit. Parkinson also recorded Cook’s interactions with  Australia’s indigenous people, marked by his role as servant of empire." attribution="Natural History Museum, London" license="public domain" aspect="1.64" %}
{% include embed/image.html src="wc:Joseph_Banks_1773_Reynolds.jpg" caption="Portrait of Sir Joseph Banks, 1733." aspect="0.81" %}
...
{% include embed/image.html src="wc:William_Bligh,_1791.jpg" caption="Portrait of Rear Admiral Captain William Bligh, 1791." aspect="0.71" %}
...
{% include embed/image.html src="Anderson.jpg" caption="Alexander Anderson (1748 – 1811) was the Superintendent to the Botanical Garden at St. Vincent. He played a major role in the introduction and proliferation of breadfruit in the Caribbean" attribution="Wikimedia Commons" license="public domain" aspect="0.73" %}
...
{% include embed/image.html src="V0044288.jpg" caption="Fruiting Branch. Coloured etching by J. Pass, c. 1796, after J. Ihle." attribution="Wellcome Collection" license="public domain" source="https://iiif.wellcomecollection.org/image/V0044288/full/full/0/default.jpg" aspect="0.71" %}
...
{% include embed/youtube.html vid="wbBJJCNL5O0" aspect="1.55" %}
...
{% include embed/image.html src="yale.jpg" caption="Illustrations like this one for the East India Company served artistic, economic, political, and scientific roles. Artist unknown." attribution="Yale Center for British Art, Paul Mellon Fund" license="public domain" aspect="1.29" %}
...
{% include embed/image.html src="V0043227.jpg" caption="Breadfruit Landscape. Coloured aquatint by W. Daniell, c. 1809, after himself." attribution="Wellcome Collection" license="public domain" source="https://iiif.wellcomecollection.org/image/V0043227/full/full/0/default.jpg" aspect="1.4" %}
...
{% include embed/image.html src="cudweedAndBreadfruit.jpg" caption="Nineteenth century depiction of breadfruit alongside cudweed and mandrake (c. 1827)." attribution="Wellcome Collection" license="public domain" aspect="0.77" %}
...
{% include embed/image.html src="mobot31753002721287_0246.jpg" aspect="0.7" %}
...
{% include embed/image.html src="breadfruitDO.jpg" caption="Breadfruit in a collection of watercolors of Asian fruits and flowers (between 1798 and 1850?)" attribution="Dumbarton Oaks" aspect="1.19" %}
...
{% include embed/image.html src="fijianMan.jpg" caption="Fijian Man carrying breadfruit (c. 1890-1910)" attribution="Museum of New Zealand Te Papa Tongarewa" license="public domain" aspect="0.77" %}
...
{% include embed/image.html src="manualoftropical00poperich_0472.jpg" aspect="0.6" %}
...
{% include embed/image.html src="Cavazzi.jpg" caption="Woman tending to field in West Africa. Enslaved Africans brought their agricultural expertise and introduced their techniques to farming practices in the Americas. Alemandini after a watercolor by Giovani Antonio Cavazzi, 1687" attribution="Jamestown-Yorktown Foundation" license="public domain" aspect="1.29" %}
...
{% include embed/image.html id="img1" src="1630435.jpg" caption="Map of the West Indies, 1736" attribution="New York Public Library" license="public domain" source="https://iiif-prod.nypl.org/index.php?id=1630435&t=v" aspect="1.65" %}
...
{% include embed/image.html src="10.5555.al.ap.specimen.bm000752555.jpg" caption="Breadfruit specimen, collected on Cook's voyage to Tahiti, 13 April 1769." aspect="0.65" %}
...
{% include embed/image.html src="iiif-service_gmd_gmd4_g4960_g4960_ar192800-full-pct_25-0-default.jpg" caption="Map of the island of Jamaica c. 1770" attribution="Library of Congress" license="public domain" source="https://tile.loc.gov/image-services/iiif/service:gmd:gmd4:g4960:g4960:ar192800/full/pct:25/0/default.jpg" aspect="1.38" %}
...
{% include embed/image.html src="wc:Derek_Walcott.jpg" caption="Photograph of Derek Walcott" aspect="0.67" %}
...
{% include embed/image.html src="wc:Starr-130316-2537-Artocarpus_altilis-leaves-Huelo-Maui_(25207536705).jpg" caption="Leaf of the breadfruit tree." aspect="1.33" %}
...
{% include embed/image.html src="iiif-service_gmd_gmd5_g5140_g5140_ct002725-full-pct_25-0-default.jpg" caption="Map of Barbados, Library of Congress, 1980" attribution="Library of Congress" license="public domain" source="https://tile.loc.gov/image-services/iiif/service:gmd:gmd5:g5140:g5140:ct002725/full/pct:25/0/default.jpg" aspect="0.76" %}
{% include embed/image.html src="wc:Mutiny_on_the_Bounty_poster.jpg" caption="Poster for the 1935 film Mutiny on The Bounty" aspect="0.67" %}
{% include embed/image.html src="wc:Poster_for_Mutiny_on_the_Bounty.jpg" caption="Poster for the 1962 remake" aspect="0.66" %}
...
{% include embed/image.html src="wc:Austin_Clarke.jpg" caption="Austin Clarke speaking at event." aspect="0.67" %}

This support of the breadfruit is borne out by the following demonstration online of its preparation.

{% include embed/youtube.html vid="b68OdOa1nX0" aspect="1.55" %}
...
{% include embed/map.html center="19.546425,-76.318746" zoom="5" %}
...
{% include embed/image.html src="wc:Jamaica_Kincaid.jpg" caption="Jamaica Kincaid speaking at the Göteborg Book Fair in September 2019." aspect="1.22" %}
...
{% include embed/image.html src="VC-map.jpg" caption="Map of St. Vincent" attribution="Central Intelligence Agency" license="public domain" source="https://www.cia.gov/the-world-factbook/static/maps/VC-map.jpg" aspect="0.93" %}
...
{% include embed/youtube.html vid="hgbfPEbH8nE" aspect="1.55" %}
...
{% include embed/youtube.html vid="eYVWuXKEwDs" aspect="1.55" %}
...
{% include embed/youtube.html vid="Xc-vzkFGZDo" aspect="1.55" %}
...
{% include embed/youtube.html vid="fyhtP_IQPsA" aspect="1.55" %}
...
{% include embed/image.html src="Parkinson5.jpg" caption="Parkinson leaf sketch, Cook Voyages 1768-1771." attribution="Natural History Museum, London" license="public domain" aspect="0.90" %}
...
{% include embed/image.html src="breadfruitTree.jpg" caption="Breadfruit in a tree. Advocates argue that breadfruit can play a central role in combatting the food and agricultural impacts of climate change." attribution="Wikimedia Commons, MKwek" license="https://creativecommons.org/licenses/by-sa/3.0/deed.en" aspect="1.51" %}
