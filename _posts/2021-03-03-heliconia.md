...
{% include embed/image.html id="img1" src="margaret-mee-portraits-of-plants.jpg" caption="Margaret Mee, Heliconia, 1964, gouache" attribution="Dumbarton Oaks" aspect="0.72" %}
{% include embed/image.html src="13685663.jpg" caption="_Heliconia chartacea_ var. _meeana_ W.J. Kress, W. John Kress and Monica M. Carlsen, Waimea Arboretum and Botanical Garden, Honolulu, HI." aspect="0.67" %}
{% include embed/image.html src="13685658.jpg" caption="_Heliconia chartacea_ var. _meeana_ W.J. Kress, W. John Kress and Monica M. Carlsen, Waimea Arboretum and Botanical Garden, Honolulu, HI." aspect="0.67" %}
...
{% include embed/image.html src="eight_families_order_Zingiberales-gigapixel-standard-scale-2_00x.jpg" aspect="1.3" caption="The eight families of the order Zingiberales showing the relationship of bananas (Musaceae) and heliconias (Heliconiaceae)." %}
{% include embed/image.html src="map_heliconia_distribution_native_SA_SP.jpg" aspect="1.98" caption="Map showing regions of South America and the South Pacific where heliconias grow as native plants. After Plants of the World Online." %}
...
{% include embed/image.html src="margaret-mee-portraits-of-plants_1.jpg" caption="Margaret Mee, _Heliconia  psittacorum_" attribution="Dumbarton Oaks" aspect="0.72" %}
...
{% include embed/image.html src="mobot31753002719653_0160.jpg" aspect="0.58" %}
{% include embed/image.html src="bhl-469080.jpg" caption="Curtis Botanical Magazine, _Heliconia  psittacorum_" attribution="Missouri Botanical Garden, Peter H. Raven Library, via BHL" aspect="0.61" %}
...
{% include embed/image.html src="mee_heliconia_uaupensis_RoyalBotanicGardenKew.jpg" aspect="0.8" caption="Margaret Mee, Heliconia uaupénsis, © Copyright The Board of Trustees of the Royal Botanic Gardens, Kew" %}
{% include embed/image.html src="margaret-mee-portraits-of-plants.jpg" aspect="0.72" %}

<!-- Smithsonian image service returns 404
{% include embed/image.html manifest="https://ids.si.edu/ids/manifest/ark:/65665/m351463ee318ba46228eb091e4f82f623e" caption="_Heliconia chartacea_ var. _meeana_, W.J. Kress, Guianas." rotation="90" aspect="" %}
-->
...
{% include embed/image.html src="heliconia_Kress_and_team_with_heliconia_DO-standard-scale-2_00x-gigapixel.jpg" aspect="1.43" caption="Photograph of John Kress (center) and team with the newly found Heliconia." %}

<!-- Smithsonian image service returns 404
{% include embed/image.html manifest="https://ids.si.edu/ids/manifest/ark:/65665/m3f47a8c4303da4eca8a2e8c80993477c4" caption="_Heliconia chartacea_ var. _meeana_ W.J. Kress, Venezuela." aspect="" %}
{% include embed/image.html manifest="https://ids.si.edu/ids/manifest/ark:/65665/m3cb339e5de25b46b8a7630b51986fef57" caption="_Heliconia chartacea_ var. _meeana_ W.J. Kress, Venezuela." aspect="" %}
{% include embed/image.html manifest="https://ids.si.edu/ids/manifest/ark:/65665/m3069ebeb405254391a4868f9eb7c90c50" caption="_Heliconia chartacea_ var. _meeana_ W.J. Kress, Venezuela." aspect="" %}
-->
...
{% include embed/image.html id="img2" src="map_heliconia_pollinators_hummingbird_bat_ltblue.jpg" caption="Heliconia distribution showing regions where plants are native (green) and introduced (purple) with pollinators. After Plants of the World Online" region="1486,3940,1005,921" aspect="1.47" %}
...
{% include embed/image.html src="variouscontrivan1886darw_0009.jpg" caption="Charles Darwin, The various contrivances by which orchids are fertilised by insects, title page, New York, Appleton,1886, Harold B. Lee Library. Harold B. Lee Library, Brigham Young University via archive.org, Not in copyright." aspect="0.60" %}
{% include embed/image.html src="variouscontrivan1886darw_0075.jpg" caption="Charles Darwin, The various contrivances by which orchids are fertilised by insects, page 31, New York, Appleton,1886, Harold B. Lee Library. Harold B. Lee Library, Brigham Young University via archive.org, Not in copyright." aspect="0.60" %}
{% include embed/image.html src="wc:NHM_Xanthopan_morgani.jpg" aspect="0.73" %}
{% include embed/image.html src="margaret-mee-portraits-of-plants_2.jpg" caption="Caroline Maschek, Angraecum sesquipedale, 1884–91, 31.5 × 24 cm, with additional sheet of thin paper measuring 28.5 × 24 cm, gouache on tinted Bristol paper." attribution="Dumbarton Oaks Research Library and Collection" aspect="0.57" %}
{% include embed/image.html src="wc:Andean_Emerald_Hummingbird_(29311503431).jpg" aspect="1.25" %}
...
{% include embed/image.html id="img3" src="margaret-mee-portraits-of-plants_3.jpg" caption="Bryan Poole, Heliconia caribeae with male hummingbirds, 2008, colored etching." aspect="0.77" %}
...
{% include embed/image.html src="margaret-mee-portraits-of-plants_4.jpg" attribution="National Museum of Natural History, Smithsonian Institution" aspect="0.77" %}
...
{% include embed/map.html id="map1" center="0.040297,-71.224280" zoom="3.8" geojson="heliconia-aurea.tsv~Heliconia aurea (magenta)" %}
...
{% include embed/image.html src="Q2727878-specimen.jpg" caption="Heliconia bihai plant specimen" aspect="0.82" %}
