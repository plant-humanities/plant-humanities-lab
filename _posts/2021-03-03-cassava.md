...
Archaeological evidence suggests that cassava became an important food staple for several ancient cultures in present-day Peru, including the [Chavin](Q13341477) (1000–200 BCE), [Nazca](Q210570) (200 BCE–600 CE), [Moche](Q208188) (250–750 CE), and [Chimú](Q901198) (1000–1470 CE).[^ref4]
...
{% include embed/image.html src="Jar-depicting-the-botanical-frog.jpg" aspect="0.8" caption="Jar Depicting the Botanical Frog, Moche, Early Intermediate Period, 100–800 CE, ceramic, 27.5 cm x 17 cm x 21 cm" %}
{% include embed/image.html src="Cassava_tuber_ground_Flickr.jpg" aspect="0.9" caption="Cassava tubers, October 13, 2007." %}
...
{% include embed/image.html src="Cassava_grater_medium.jpg" aspect="0.78" caption="Cassava grater, WaiWai people, Guyana." %}
{% include embed/image.html src="012.700x700.jpg" aspect="1.52" %}
{% include embed/image.html src="cassava-4.jpg" aspect="2.72" caption="_Tipiti, Manioc Squeezer_, Tukuna, Ticuna, Maguta, Guyana, cutting, weaving, 122.3 cm. (length)" %}
...
{% include embed/image.html src="Cassava_distribution_map_4.jpg" region="2188,991,1452,1275" aspect="1.98" caption="Global distribution of cassava. Cassava’s native habitat is marked in green, and regions where cassava was introduced by humans are marked in orange." %}
...
{% include embed/image.html src="Crosby_Cassava_Mural_Flickr.jpg" aspect="1.47" caption="Njideka Akunyili Crosby, Obodo (Country/City/Town/Ancestral Village), outdoor mural, MOCA Grand Avenue, Los Angeles, CA, September 30, 2018." %}
