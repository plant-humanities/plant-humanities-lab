...
{% include embed/map.html center="4.98477,-182.98311" zoom="0.5" geojson="drake.json~Drake's circumnavigation between 1577 and 1580." %}
...
{% include embed/image.html id="img1" src="Drake.jpg" region="944,1013,3162,2688" aspect="1.25" %}
...
{% include embed/image.html src="bhl-58480828.jpg" aspect="0.66" %}
{% include embed/image.html src="bhl-58480797.jpg" aspect="0.70" %}
...
{% include embed/image.html src="bhl-58480796.jpg" aspect="0.66" %}
...
{% include embed/image.html src="58VbAAAAQAAJ_PA28.jpg" caption="Page from Simplicium medicamentorum ex novo orbe delatorum, quorum in medicina usus est, historia Hispan. sermone descripta" source="https://books.google.com/books/content?id=58VbAAAAQAAJ&hl=it&pg=PA28&img=1&zoom=3&bul=1&sig=ACfU3U301EvEkTa9RXDbUJhUZuMqsAvQbQ&w=1025" aspect="0.65" %}
{% include embed/image.html src="bhl-58480797.jpg" aspect="0.70" %}
...
{% include embed/map.html center="-9.130550123807534,-70.78263840714388" zoom="3.5" geojson="pre_conquest.json~Map of Latin America displaying the approximate regional footprint of indigenous populations prior to Spanish conquests." %}
...
{% include embed/iframe.html src="https://cdn.knightlab.com/libs/timeline3/latest/embed/index.html?source=18EgV6ZTmJmPWsCk7zXklA4O8GlK9uCO4TTjg5NZkVPo&timenav-position=bottom&hash-bookmark=false&initial-zoom=1" class="full" %}
...
{% include embed/image-compare.html before="Compare_B.jpg" after="Compare_FC.jpg" class="right" %}
...
{% include embed/image.html src="Florentine_Codex_Open.jpg" aspect="1.56" %}
...
{% include embed/image.html src="FC_Coanenepilli.jpg" aspect="1.50" %}
...
{% include embed/image.html src="bhl-55231362.jpg" region="1,166,2566,2192" aspect="0.74" %}
{% include embed/image.html src="bhl-42728883.jpg" aspect="0.74" %}
...
{% include embed/image.html src="10.5555_al.ap.specimen.br0000013080891.jpg" aspect="0.60" %}
{% include embed/image.html src="10.5555_al.ap.specimen.p00307405.jpg" aspect="0.63" %}
{% include embed/image.html src="10.5555_al.ap.specimen.e00413821.jpg" aspect="0.61" %}
...
{% include embed/image.html src="bhl-40358907.jpg" aspect="0.57" %}
{% include embed/image.html src="bhl-40289149.jpg" aspect="0.57" %}
...
{% include embed/map.html center="19.435,-99.131389" zoom="5" geojson="Nahua.json" %}
...
{% include embed/image.html src="Contrayerva_specimen.jpg" aspect="0.69" %}
...
{% include embed/image.html src="4241393.jpg" source="https://digital.ub.uni-duesseldorf.de/download/webcache/2000/4241393" aspect="0.82" %}
...
{% include embed/image.html src="Fever_water.jpg" aspect="1.24" %}
...
{% include embed/image.html src="bhl-673094.jpg" aspect="0.71" %}
...
{% include embed/image.html src="wc:Dorstenia_contrajerva.jpg" region="0,2190,4012,3474" aspect="0.63" %}
