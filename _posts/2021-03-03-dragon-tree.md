...
{% include embed/image.html src="923a4fd5cd19774b9251274f6c0edbf8f355bdb575101414f54cff74c404fc4e.jpg" aspect="0.67" caption="D. draco" %}
...
{% include embed/image.html src="e1637c277aec8ab1f77a9717561584e57eda0ed96e72f1033f17811858df1552.jpg" aspect="1.11" caption="Vedic Tale of the Elephant and the Dragon. Giraldus Cambrensis, Bestiary, (England: c.1225–1250), f58" attribution="A bestiary with additions from Gerald of Wales's _Topographia Hibernica_ (Harley MS 4751)" %}
...
{% include embed/image.html src="Dragons_blood_tree_Flickr__Rod_Waddington_CC_BY_SA_2.0.jpg" aspect="0.77" caption="Dragon's Blood Tree, Socotra Island, Yemen, 2013." %}
...
{% include embed/map.html center="Q105967" zoom="4" basemap="Esri_WorldPhysical" caption="Distribution range of _Dracaena draco_." geojson="Dracaena-draco-native.json" %}
...
{% include embed/image.html src="04ab805fb5472693deb181faf8b9b47d0f3b1bc6eb5a29c6b2bbeb11e14f.jpg" caption="The Flight into Egypt, first known etching of the Dragon Tree" source="https://jqz7t23pp9.execute-api.us-east-1.amazonaws.com/dev/manifest/751f7/manifest.json" aspect="0.67" %}
...
{% include embed/youtube.html vid="C0CIRCjoICA" caption="Sylbo, The Last Speakers of the Lost Whistling Language." aspect="1.55" %}
...
{% include embed/image.html src="51906905.jpg" aspect="0.65" caption="An image of the Draco arbor in Gerard's Herball, p. 1524." attribution="_The Herball, or Generall Histoire of Plantes_, (London: 1633)" %}
{% include embed/image.html src="56601428.jpg" aspect="0.66" caption="Draco arbor in Parkinson, Theatrum Botanicum, (London, 1640), p. 1531" attribution="_Theatrum Botanicum_" %}
...
{% include embed/image.html src="DP-1411-001.jpg" caption="Julius Schrader, Baron Alexander von Humboldt (1769–1859), oil on canvas, 1859, Metropolitan Museum of Art, public domain." source="https://images.metmuseum.org/CRDImages/ep/original/DP-1411-001.jpg" aspect="0.87" %}
{% include embed/image.html src="wc:Map_Alexander_von_Humboldt_expedition-en.svg" aspect="1.49" %}
{% include embed/image.html src="wc:Berthelot_drago_franchy.jpg" aspect="1.25" %}
...
{% include embed/image.html src="Dracaena_Humboldt.jpg" caption="Marchais, ‘Le dragonier de l’Orotava,’ in: Alexander von Humboldt, _Vue des cordillères, et monumens des peuples indigènes de l’Amerique_ (Paris: F. Schoell, 1810), vol. 2, Planche 69. Dumbarton Oaks, Courtesty of Dumbarton Oaks." region="866,1834,2130,1509" aspect="0.69" %}
...
{% include embed/image.html src="459304936.jpg" caption="Harvard University, Dumbarton Oaks Research Library, PHPC002_K4464" source="https://iiif.lib.harvard.edu/manifests/ids:459304936" aspect="1.64" %}
...
{% include embed/image.html src="IMG_9319.jpg" caption="A small outcrop of Dracaena draco trees at the oldest botanical garden on the Canary Islands, the Jardin Botanico Canario Viera y Clavijo in Gran Canaria, Spain. Photo taken by Thomas C. Anderson, July 2019." aspect="0.75" %}
...
{% include embed/image.html src="2c03226df2f0fdc825a206069fcd2f90653692240d8c0f1733b2e7d981bc.jpg" caption="Dragon Tree at Orotava" source="https://jqz7t23pp9.execute-api.us-east-1.amazonaws.com/dev/manifest/7b1dr/manifest.json" aspect="0.69" %}
...
{% include embed/image.html src="wc:Orotava_Ayuntamiento_04.jpg" aspect="0.78" %}
