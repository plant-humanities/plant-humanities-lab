...
{% include embed/map.html center="49.408,-63.531" zoom="5" basemap="Esri_WorldPhysical" caption="Gulf of Saint Lawrence" markers="Q3339246" geojson="cartier.json" %}
...
{% include embed/map.html center="Q544356" zoom="5.5" basemap="Esri_WorldPhysical" caption="Gulf of Saint Lawrence" geojson="St_Lawrence_Iroquoians.json" %}
...
{% include embed/map.html center="48.402,2.7003" zoom="4.5" basemap="Esri_WorldPhysical" caption="Locations where accounts of Cartier's expeditions were published." geojson="cartier_publishing.json" %}
...
{% include embed/map.html center="Q2145" zoom="3" basemap="Esri_WorldPhysical" markers="Q2145" geojson="ThujaDistribution.json" %}
...
{% include embed/map.html center="42.655,-74.715" zoom="3.5" basemap="Esri_WorldPhysical" caption="Thuja Distribution" geojson="ThujaDistribution.json" %}
...
{% include embed/map.html center="Q544356" zoom="6" basemap="Esri_WorldPhysical" caption="Territory occupied by the St. Lawrence Iroquoians, circa 1535" geojson="St_Lawrence_Iroquoians.json~St. Lawrence Iroquoians" %}
...
{% include embed/image.html src="wc:A_case_of_Scurvy_journal_of_Henry_Walsh_Mahon.jpg" aspect="0.63" %}
...
{% include embed/map.html center="48.402,2.700" zoom="10" caption="France" aspect="1" %}
{% include embed/image.html src="wc:Fontainebleau_bird%27s_eye_view.jpg" aspect="0.74" %}
...
{% include embed/map.html center="14.9963,6.7126" zoom="2" basemap="Esri_WorldPhysical" caption="Territory of the First French Empire (blue) and Second French Empire (light blue)" geojson="French_Empire.json" %}
...
{% include embed/map.html center="Q48335" zoom="5" basemap="Esri_WorldPhysical" caption="Newfoundland" geojson="Newfoundland.json" %}
...
{% include embed/map.html center="52.282,-5.244" zoom="5" basemap="Esri_WorldPhysical" caption="Journey of the HMS Salisbury" geojson="Lind.json" %}
