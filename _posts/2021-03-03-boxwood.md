...
{% include embed/map.html center="Q90" zoom="8" caption="French royal gardens where Claude Mollet experimented with boxwood." markers="Q90" %}
...
{% include embed/image.html src="Old-Summer-Palace_Beijing_British-Museum.jpg" aspect="1.63" caption="Imperial garden of the Old Summer Palace in Beijing. Unknown artist, after Yilantai, c. 1783-1786." attribution="*Twenty views of the European Palaces of the Yuanming yuan*" %}
...
{% include embed/image.html src="Boxwood-blight-in-Dumbarton-Oaks-garden_pre-removal1.jpg" aspect="1.33" caption="Boxwood in the Dumbarton Oaks garden, before removal." %}
{% include embed/image.html src="Boxwood-blight-in-Dumbarton-Oaks-garden_pre-removal2.jpg" aspect="1.33" caption="Boxwood blight at the Dumbarton Oaks garden." %}
{% include embed/image.html src="Boxwood-blight-in-Dumbarton-Oaks-garden_post-removal.jpg" aspect="1.33" caption="Boxwood in the Dumbarton Oaks garden, after removal." %}
